@php
    $cards = [
        ['General', 'Regional display, retention, and security defaults.', 'settings', route('settings.general.edit'), true],
        ['Notifications', 'Email alerts when a node goes quiet or mail stops flowing.', 'bell', route('settings.notifications.edit'), true],
    ...
    if (auth()->user()->isAdmin()) {
        ...
        $cards[] = ['Users & Admins', 'Manage operator staff and customer portal logins.', 'users', route('settings.users.index'), true];
